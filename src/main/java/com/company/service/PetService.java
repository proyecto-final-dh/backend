...
public class PetService implements IPetService {
    ...
    public Pets update(int id, Pets updatedPets) {
        Optional<Pets> existingPet = petsRepository.findById(id);
    ...
    public PetWithImagesDto saveOwnPetWithImages(CreatePetDto pet, MultipartFile[] images) {
        ...
        Pets savedPet = petsRepository.save(fullPet);
    ...
    public void deleteById(int id) throws Exception {
        Optional<Pets> species = petsRepository.findById(id);
    ...
    public List<Pets> findPetsRecommendations(int petId, int limit) throws Exception {
        ...
        if (petOptional.isPresent()) {
            ...
            List<Pets> recommendationsAll = petsRepository.findPetsRecommendationsAll(petId);
            ...
            if (recommendations.size() < limit) {
                ...
                List<Pets> specieStatusRecommendations = petsRepository.findPetsRecommendationsSpecieStatus(petId);
            ...
            if (recommendations.size() < limit) {
                ...
                List<Pets> statusRecommendations = petsRepository.findPetsRecommendationsStatus(petId);
    ...
    public Page<Pets> findByStatus(PetStatus status, Pageable pageable) throws Exception {
        try {
            return petsRepository.findByStatus(status, pageable);
        } catch (Exception e) {
    ...
    public Page<Pets> filterPets(String location, String species, Integer breedId, String size, String status, Pageable pageable) throws Exception {
        try {
            ...
            return petsRepository.findAll(spec, pageable);
        } catch (Exception e) {
    ...
    public Page<Pets> findByLocation(int id, Pageable pageable) throws Exception {
        validateLocation(id);
        try {
            return petsRepository.findByLocation(id, pageable);
        } catch (Exception e) {
            throw new Exception("Error al recuperar las mascotas paginadas.");
        }
    }
    ...
    public Page<Pets> findByOwner(int id, Pageable pageable) throws Exception {
        ...
        try {
            return petsRepository.findByOwner(id, pageable);
        } catch (Exception e) {
            throw new Exception("Error al recuperar las mascotas paginadas.");
        }
    }
